...
public class ImageRenderer extends RajawaliCardboardRenderer {


    public ContextWrapper contextWrapper;


    public ImageRenderer(ContextWrapper c) {
        super(c);
        contextWrapper = c;
...
*/
       ...
       // Bitmap bitmap = BitmapFactory.decodeStream(fis);
         Bitmap bitmap = BitmapFactory.decodeResource(contextWrapper.getResources(), R.raw.pan02);
